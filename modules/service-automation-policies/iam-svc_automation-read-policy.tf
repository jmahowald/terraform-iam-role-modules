resource "aws_iam_policy" "svc_automation_read_policy" {
    name = "${var.name_prefix}_read_policy"
    path = "/"
    policy = "${data.aws_iam_policy_document.svc_automation_read_policy.json}"
}
